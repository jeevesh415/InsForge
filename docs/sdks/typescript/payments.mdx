...
<Note>
  See [Payments Architecture](/core-concepts/payments/architecture) for setup, Stripe key management, webhook projections, and fulfillment patterns.
</Note>
...
Populate those tables from webhook-projected payment state. See [Payments Architecture](/core-concepts/payments/architecture#custom-fulfillment-logic) for examples.
