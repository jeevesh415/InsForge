...
<CardGroup cols={2}>
  ...
  <Card title="Flutter" icon="mobile" href="/sdks/flutter/auth">
...
<CardGroup cols={3}>
  <Card title="React" icon="react" href="/sdks/typescript/ui-components/react">
    React + Vite apps
  </Card>

  <Card title="Next.js" icon="n" href="/sdks/typescript/ui-components/nextjs">
    Next.js with SSR
  </Card>

  <Card title="Custom UI" icon="paintbrush" href="/sdks/typescript/ui-components/customization">
    Build your own
  </Card>
</CardGroup>
